...
# 2. Define a preprocessing function that matches ResNet50's requirements
def preprocess_to_resnet_specs(image):
    # Example: resize to 224x224, cast, normalize according to ResNet50
...
def get_embedding(image):
    image = preprocess_to_resnet_specs(image)
